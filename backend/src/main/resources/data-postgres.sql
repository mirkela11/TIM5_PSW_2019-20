...
insert into examination_type(id, label, price, clinic_id) values (1,'Hirurg', '1000', 100);
insert into clinic_administrator(id, email, name, number, password, surname, clinic_id) values (100, 'nemanja@email.com', 'Nemanja', '123456789', 'Mirkela97', 'Mirkovic', 100);
...
insert into doctor(id, email, name, password, phone, status, surname, work_hours_from, work_hours_to,clinic_id, specialized_id) values (1,'doctor@email.com','Doctor','Doctor123','123467911','ACTIVE','Docic','08','16',100,1);
insert into users(id, email, password, role) values (102, 'doctor@email.com', 'Doctor123', 1);
insert into nurse(id, email, name, password, phone, surname, work_hours_from, work_hours_to, clinic_id) values (1,'nurse@email.com', 'Nurse', 'Nurse123','153426010', 'Nursic', '8:00', '16:00', 100);
