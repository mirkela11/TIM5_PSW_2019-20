...
let LoginComponent = class LoginComponent {
    constructor(patientService, formBuilder, router, userService, doctorService, nurseService, clinicalCentreAdministratorService) {
...
class Doctor {
    constructor(email, password, name, surname, number1, workHoursFrom, workHoursTo) {
        this.email = email;
        this.password = password;
        this.name = name;
        this.surname = surname;
