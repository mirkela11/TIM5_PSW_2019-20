(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PatientMakeExaminationComponent = /** @class */ (function () {
                ...
                PatientMakeExaminationComponent.prototype.save = function () {
                    ...
                    this.examinationServce.makeExamination(interval, this.user.email, this.doctor.email, this.type, this.clinic.id.toString()).subscribe(function (data) {
                        _this.dialogRef.close();
                    }, function (error) {
                        console.log(error);
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ExaminationService = /** @class */ (function () {
                ...
                ExaminationService.prototype.makeExamination = function (date, patientEmail, doctorEmail, type, clinicId) {
                    var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpParams"]();
                    params = params.append('date', date);
