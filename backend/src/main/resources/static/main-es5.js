(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(patientService, formBuilder) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RegistrationComponent = /** @class */ (function () {
                function RegistrationComponent(patientService, formBuilder, router) {
                    this.patientService = patientService;
                    this.formBuilder = formBuilder;
                    this.router = router;
                    this.submitted = false;
                ...
                RegistrationComponent.prototype.ngOnInit = function () {
                    this.registerForm = this.formBuilder.group({
                        ...
                        phoneNumber: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(9)]),
                        healthInsuranceID: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(13), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(13)]),
                    });
                };
                ...
                RegistrationComponent.prototype.onSubmit = function () {
                    ...
                    this.patient = new _model_patient__WEBPACK_IMPORTED_MODULE_2__["Patient"](this.f.email.value, this.f.password.value, this.f.firstName.value, this.f.lastName.value, this.f.phoneNumber.value, this.f.address.value, this.f.city.value, this.f.country.value, this.f.healthInsuranceID.value, _model_patientStatus__WEBPACK_IMPORTED_MODULE_6__["PatientStatus"].AWAITING_APPROVAL);
                    this.createPatient();
                };
                RegistrationComponent.prototype.createPatient = function () {
                    ...
                    this.patientService.newPatient(this.patient).subscribe(function (data) {
                        _this.router.navigate(['/patient/pending-approval']);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var Patient = /** @class */ (function () {
                function Patient(email, password, name, surname, phone, address, city, country, InsuranceID, status) {
                    this.email = email;
                    this.password = password;
                    this.name = name;
