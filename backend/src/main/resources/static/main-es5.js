...
<<<<<<< HEAD
                function LoginComponent(patientService, formBuilder, router, userService, doctorService, nurseService, adminClinicService, clinicalCentreAdministratorService) {
=======
